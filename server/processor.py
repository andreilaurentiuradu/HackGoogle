...
class StreamingStats:
    """
    Statistici EMA cu alpha time-adaptive.
...
class DataStreamProcessor:
    ...
    def add_data(self, data):
        ...
        if (
            ...
            enriched["_stress_score"] = self.stress.predict()

            return self.brain.process_stats(self.stats, enriched)

        return None

    def _update_stress(self, data):
        raw = data.get("raw_sensors", data)
        hs = data.get("health_services", data)
